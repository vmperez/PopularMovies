...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setElevation throws NPE if elevation is not 0
    ...
    @Override
    public void onLoadFinished(@NonNull Loader<List<MovieInfo>> loader, List<MovieInfo> data) {
    ...
    @Override
    public void onLoaderReset(@NonNull Loader<List<MovieInfo>> loader) {
        // Not used
    }
